...
if service=="start_new_os":
	...
	print(output1[1])
	print()
	output2=subprocess.getstatusoutput("sudo docker run  --name  {} {}".format(os_name, image_name))
	print(output2[1])
...
if service=="launch_terminal":
	output=subprocess.getstatusoutput('sudo docker start {}| {}'.format(os_name,cmd))
	print(output[1])
